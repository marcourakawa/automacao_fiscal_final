...
def preencher_campos(linha, index):
    ...
    # Clica para inseir filial
    pyautogui.click(x=811, y=255)
    time.sleep(0.8)
    pyautogui.click(x=811, y=255)
    time.sleep(0.8)
    ...
    # Clicar em procurar
    pyautogui.click(x=998, y=247)
    pyautogui.click(x=998, y=247)
    time.sleep(1)

    # Clicar em ok
    pyautogui.click(x=305, y=597)
    pyautogui.click(x=305, y=597)
    time.sleep(4)
    ...
    for campo in CAMPOS_ORDEM:
        ...
        if campo == "NOTA_FISCAL":
            ...
            pyautogui.click(x=1294, y=540)
            time.sleep(1)

            # Navega até o campo Chave NFE
            pyautogui.click(x=698, y=578)
            time.sleep(1)
